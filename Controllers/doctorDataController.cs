...
namespace team2Geraldton.Controllers
{
    public class doctorDataController : ApiController
    {
        ...
        [Route("api/doctorData/helloworld")]
        [HttpGet]
        public string Get()
        {
            return "Hello World";
        ...
        // GET: api/doctorData
        /// <summary>
        /// This is called by the list, to fetch all te doctors in the database.
        /// </summary>
        //[Route("api/doctorData/Getdoctors")]
        ...
        /// <summary>
        /// Gets a list of doctors in the database alongside a status code (200 OK). 
        ...
        [Route("api/doctorData/getdoctorspage/{StartIndex}/{PerPage}")]
        ...
        /// </summary>
        /// <param name="doctor">A doctor object. Sent as POST form data.</param>
        ...
        /// <summary>
        /// Updates doctor in the database given information about the doctor.
        /// </summary>
        /// <param name="id">Doctor's id</param>
        /// <param name="doctor">doctor object. Received as a POST data.</param>
        /// <returns></returns>
        /// <example>
        ...
        [HttpPost]
        //[Authorize(Roles = "Admin")]
        //[Route("api/doctorData/UpdateDoctor/{id}")]
        ...
        // DELETE: api/doctorData/DeletedoctorGet/{id}
        //Due to the GET method it can be tested using curl command.
        [HttpGet]
        public IHttpActionResult DeletedoctorGet(int id)
        {
            doctor doctor = db.doctors.Find(id);
            if (doctor == null)
            {
        ...
        // DELETE: api/doctorData/Deletedoctor/{id}
        // Use the POST method
        [HttpPost]
