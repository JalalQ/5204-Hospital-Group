...
namespace team2Geraldton.Controllers
{
    public class JobApplicationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "JobApplicationId,FirstName,LastName,Dob,Email,Contact,Address,Qualification,Experience")] JobApplication jobApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JobApplicationId,FirstName,LastName,Dob,Email,Contact,Address,Qualification,Experience")] JobApplication jobApplication)
        {
            if (ModelState.IsValid)
            {
