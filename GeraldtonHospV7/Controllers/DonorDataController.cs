...
namespace GeraldtonHospV7.Controllers
{
    public class DonorDataController : ApiController
    {
        ...
        //Choose model "Donor"
        //Choose context "Gerald Hosp Context"
        ...
        /// <summary>
        /// Gets a list of Donations in the database that match a particular Donor alongside a status code (200 OK).
        /// </summary>
        ...
        [ResponseType(typeof(IEnumerable<DonorDto>))]
        public IHttpActionResult GetDonorsForDonation(int id)
        {
            // IN SQL
            //WHERE Donations.Donorid = {id}
            List<Donation> Donations = db
                .Donations
