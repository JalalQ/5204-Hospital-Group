...
namespace GeraldtonHospV7.Models
{
    ...
    public class GeraldtonHospV7DbContext : IdentityDbContext<ApplicationUser>
    {
        public GeraldtonHospV7DbContext()
            : base("DefaultConnection", throwIfV1Schema: false)
        {
        }

        public static GeraldtonHospV7DbContext Create()
        {
            return new GeraldtonHospV7DbContext();
        }
